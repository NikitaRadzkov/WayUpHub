...
//SecondMenu
let iconMenuSecond = document.querySelector('.icon-menu-second');
let menuBodySecond = document.querySelector('.menu-body-second');
if (iconMenuSecond) {
   iconMenuSecond.addEventListener('click', function (e) {
      document.body.classList.toggle('_lock');
      iconMenuSecond.classList.toggle('_active');
      menuBodySecond.classList.toggle('_active');
   });
}
//=================
//BodyLock
...
if (goto_links) {
   for (let index = 0; index < goto_links.length; index++) {
      ...
      goto_link.addEventListener('click', function (e) {
         ...
         } else if (iconMenuSecond.classList.contains('_active')) {
            document.body.classList.remove('_lock');
            iconMenuSecond.classList.remove('_active');
            menuBodySecond.classList.remove('_active');
         }
